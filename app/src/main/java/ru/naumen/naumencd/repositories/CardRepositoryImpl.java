...
public class CardRepositoryImpl implements CardRepository {
    ...
    public CardRepositoryImpl(CardApi cardApi, AppDatabase appDatabase, Timer timer, SchedulerProvider schedulerProvider) {
    ...
    @Override
    public Observable<List<SimilarItemEntity>> getComputersSimilar(int id) {
